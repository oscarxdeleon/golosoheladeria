// ---------------------------------------------------------------------------
// Lectura tolerante de las variables de entorno de Evolution API.
...
// "TOKEN_DE_WEBHOOK_DE_EVOLUCION"), sin importar acentos, mayúsculas o guiones.
// Solo se usa en código de servidor.
// ---------------------------------------------------------------------------
...
export function readEvolutionEnv(
  canonical: "EVOLUTION_API_URL" | "EVOLUTION_API_KEY" | "EVOLUTION_WEBHOOK_TOKEN",
): string | undefined {
