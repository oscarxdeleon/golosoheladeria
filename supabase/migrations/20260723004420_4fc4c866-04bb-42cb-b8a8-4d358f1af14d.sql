...
BEGIN
  ...
  -- Sabores agrupados POR GRUPO DE MODIFICADOR (para no mezclar helados con jugos)
  SELECT coalesce(jsonb_agg(g_row ORDER BY (g_row->>'group_name')), '[]'::jsonb)
  ...
  -- TODOS los productos activos de la sede (no solo top 40) para que la IA
  -- pueda responder precios exactos de productos especiales o poco comunes.
