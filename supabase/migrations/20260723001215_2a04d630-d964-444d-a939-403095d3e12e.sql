...
BEGIN
  ...
  -- Sabores disponibles en esta sede
  -- (modificadores activos del/los grupo(s) cuyo nombre contiene "sabor",
  --  excluyendo los deshabilitados para esta sede)
  ...
  -- Productos activos visibles en la sede (favoritos primero, máx 40)
