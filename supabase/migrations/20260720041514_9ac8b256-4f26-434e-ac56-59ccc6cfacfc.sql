...
BEGIN
  ...
  -- Autorización: cualquier usuario con rol operativo (cajero, supervisor,
  -- admin) puede cerrar la caja de la sede. La caja pertenece al turno,
  -- no al usuario que la abrió.
  IF NOT (
  ...
  -- Nombre de quien cierra (para auditoría cuando difiere del que abrió)
