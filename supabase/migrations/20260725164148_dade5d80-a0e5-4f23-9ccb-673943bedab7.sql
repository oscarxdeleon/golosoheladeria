...
BEGIN
  ...
  -- Regla definitiva: cualquier mensaje con producto/intención de pedido va a IA.
  -- No se responde bienvenida ni menú fijo para evitar el loop reportado por clientes.
  IF v_is_order_intent AND v_ai_authorized THEN
    RETURN jsonb_build_object('reply', null, 'use_ai', true, 'source', 'order_intent');
  END IF;

  -- Dentro del cooldown: continuar la conversación con IA; nunca repetir bienvenida.
  ...
  -- La bienvenida sólo aplica a saludos explícitos. Si el primer mensaje es un producto,
  -- pedido o pregunta real, cae a IA y Golosito continúa la conversación.
...
SET ai_enabled = true,
    ai_sandbox_numbers = ARRAY[]::text[],
    welcome_messages = ARRAY[
      '🍦 ¡Hola! Soy Golosito, tu asistente de Heladería Goloso. Será un gusto ayudarte con tu pedido. Menú 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-santa',
      '🍨 ¡Bienvenido! Soy Golosito, tu asistente de Goloso Santa. Cuéntame qué te provoca hoy y te ayudo a armar tu pedido. Menú 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-santa',
      '✨ ¡Hola! Soy Golosito 🍦. Dime qué te gustaría pedir o mira el menú aquí 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-santa'
    ]
...
SET ai_enabled = true,
    ai_sandbox_numbers = ARRAY[]::text[],
    welcome_messages = ARRAY[
      '🍦 ¡Hola! Soy Golosito, tu asistente de Heladería Goloso. Será un gusto ayudarte con tu pedido. Menú 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-parque',
      '🍨 ¡Bienvenido! Soy Golosito, tu asistente de Goloso Parque. Cuéntame qué te provoca hoy y te ayudo a armar tu pedido. Menú 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-parque',
      '✨ ¡Hola! Soy Golosito 🍦. Dime qué te gustaría pedir o mira el menú aquí 👇 https://golosoheladeria.vercel.app/menu?sede=goloso-parque'
    ]
