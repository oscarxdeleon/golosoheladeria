...
BEGIN
  ...
  -- Bloqueamos la fila activa del usuario para evitar carreras
...
GRANT EXECUTE ON FUNCTION public.close_cash_session(numeric, text) TO authenticated, service_role;
