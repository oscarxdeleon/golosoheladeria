...
PRIMARY_DOWNLOAD_URL="https://golosoheladeria.lovable.app/downloads/golosito.zip"
FALLBACK_DOWNLOAD_URL="https://golosoheladeria.lovable.app/downloads/whatsapp-bot.zip"
...
rm -f "${TARGET_DIR}/.goloso-bot.lock" "${TARGET_DIR}/.goloso-bridge-update-8.22.2" "${TARGET_DIR}/.goloso-bridge-update-8.22.3" "${TARGET_DIR}/.goloso-bridge-update-8.22.4" "${TARGET_DIR}/.goloso-bridge-update-8.22.5" "${TARGET_DIR}/.goloso-bridge-update-8.22.6" "${TARGET_DIR}/.goloso-bridge-update-8.22.7" "${TARGET_DIR}/.goloso-bridge-update-8.22.8" || true
