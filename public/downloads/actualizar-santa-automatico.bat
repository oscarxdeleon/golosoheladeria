...
echo.
echo ============================================================
echo   Goloso WhatsApp Bot - Actualizador automatico (%SEDE%)
echo ============================================================
echo.
...
echo.
echo Conectando y ejecutando la actualizacion. Puede tardar 2-4 minutos...
...
if "%EC%"=="0" (
  echo ============================================================
  echo   Actualizacion de %SEDE% finalizada correctamente.
