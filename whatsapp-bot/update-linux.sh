...
rm -f "${TARGET_DIR}/.goloso-bot.lock" "${TARGET_DIR}/.goloso-bridge-update-8.22.2" "${TARGET_DIR}/.goloso-bridge-update-8.22.3" "${TARGET_DIR}/.goloso-bridge-update-8.22.4" "${TARGET_DIR}/.goloso-bridge-update-8.22.5" "${TARGET_DIR}/.goloso-bridge-update-8.22.6" "${TARGET_DIR}/.goloso-bridge-update-8.22.7" || true
